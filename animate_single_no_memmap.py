...
def images_to_memory(image_dir):
    """
    Takes a directory containing images and loads them all into memory.
    Returns a list of images, num_frames, frame_width, frame_height
    """
    ...
    # Return list of images and frame details
    num_frames = len(images)
    return images, num_frames, frame_width, frame_height
...
def animate_eye(images, num_frames, frame_height, frame_width, background_image_path, enable_y_coords, debug):
    ...
    while True:
        # Read the current frame from memory
...
if __name__ == "__main__":
    ...
    images, num_frames, frame_width, frame_height = images_to_memory(image_dir="cropped_eyes_2_resized")
